...
export const adminUi = {
  ...
  content: "p-6 md:p-8 w-full",
  contentNarrow: "p-6 md:p-8 w-full max-w-3xl mx-auto",
  contentWide: "p-6 md:p-8 w-full max-w-5xl mx-auto",
  h1: "text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-tight",
  subtitle: "text-sm text-gray-500 dark:text-gray-400 mt-1",
  card: "bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 md:p-8",
  sectionTitle:
